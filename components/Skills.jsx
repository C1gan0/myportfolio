        ...
        <section id="skills" className="py-10 bg-gray-800 relative">
          <div className="mt-8 text-gray-100 text-center">
            <h3 className="text-4xl font-semibold">
              Minhas <span className="text-indigo-600">Habilidades</span>
            </h3>
            ...
            <div 
            key={i} 
            className="border-2 group border-indigo-600 relative min-w-
            [10rem] max-w[16rem] bg-gray-900 p-10 rounded-xl"
            >
              <div 
                style={{
                background: `conic-gradient(rgb(7,145,170) ${skill.count}%,
                #ddd ${skill.count}%)`,
              }} 
